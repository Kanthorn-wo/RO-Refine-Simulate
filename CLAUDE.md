...
version ปัจจุบัน: **1.6.0** (เรียงเลขใหม่ทั้ง CHANGELOG เมื่อ 2026-06-10 — เลขเก่า 1.9.3 ถูก renumber เป็น 1.6.0)
