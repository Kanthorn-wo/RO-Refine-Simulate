export const TRANSLATIONS = {
  th: {
    ...
    sim_budget_note: '90% ของรอบ "{label}" ไม่เกิน {p90} {unit} · ครึ่งหนึ่งของรอบไม่เกิน {median} {unit}',
  ...
  en: {
    ...
    sim_budget_note: '90% of rounds used at most {p90} {unit} of "{label}" · half used at most {median} {unit}',
