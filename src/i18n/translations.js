export const TRANSLATIONS = {
  th: {
    ...
    sim_budget_note: 'พูดง่าย ๆ: ส่วนใหญ่ "{label}" จะอยู่แถว ๆ {median} {unit} · แต่ถ้าอยากชัวร์ เตรียมไปเลย {p90} {unit} — พอแทบทุกรอบ (10 รอบจะเจอรอบซวยจริง ๆ แค่รอบเดียว)',
  ...
  en: {
    ...
    sim_budget_note: 'Simply put: "{label}" usually lands around {median} {unit} · want to play it safe? bring {p90} {unit} — enough almost every time (only ~1 unlucky round in 10)',
