export const TRANSLATIONS = {
  th: {
    ...
    sim_summary: 'ค่าเฉลี่ยต่อรอบ',
    sim_min_summary: 'ค่าต่ำสุดต่อรอบ (Min)',
    sim_max_summary: 'ค่าสูงสุดต่อรอบ (Max)',
    sim_rounds_unit: 'รอบ',
  ...
  en: {
    ...
    sim_summary: 'Average per round',
    sim_min_summary: 'Minimum per round (Min)',
    sim_max_summary: 'Maximum per round (Max)',
