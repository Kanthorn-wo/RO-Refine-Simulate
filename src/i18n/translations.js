export const TRANSLATIONS = {
  th: {
    ...
    sim_budget_note: 'ตีจาก +{start} จนถึง +{target} สำเร็จ 1 เที่ยว: ปกติจะเจอ "{label}" ราว ๆ {median} {unit} — ถ้าเตรียมไป {p90} {unit} แล้วตีแบบนี้ 10 เที่ยว จะมีแค่ ~1 เที่ยวเท่านั้นที่ของไม่พอ',
  ...
  en: {
    ...
    sim_budget_note: 'One full run from +{start} to +{target}: "{label}" is usually around {median} {unit} — bring {p90} {unit} and out of 10 runs only ~1 would come up short',
