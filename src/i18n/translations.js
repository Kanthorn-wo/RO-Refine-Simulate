export const TRANSLATIONS = {
  th: {
    ...
    sim_budget_note: 'อัพ +{start} ไป +{target}: ส่วนใหญ่ "{label}" ประมาณ {median} {unit} · เตรียม {p90} {unit} ก็แทบชัวร์ว่าพอ (โอกาสไม่พอ ~10%)',
  ...
  en: {
    ...
    sim_budget_note: '+{start} to +{target}: "{label}" is usually about {median} {unit} · bring {p90} {unit} to be nearly safe (~10% chance of running out)',
