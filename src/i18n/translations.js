export const TRANSLATIONS = {
  th: {
    ...
    sim_budget_note: 'แปลผล: รอบทั่วไป (ดวงกลาง ๆ) "{label}" อยู่ที่ ~{median} {unit} · ถ้าเผื่อไว้ {p90} {unit} จะพอใน 9 จาก 10 รอบ (มีแค่ 1 ใน 10 รอบที่ดวงแย่กว่านี้)',
  ...
  en: {
    ...
    sim_budget_note: 'How to read: a typical round (median luck) needs ~{median} {unit} of "{label}" · budgeting {p90} {unit} covers 9 out of 10 rounds (only 1 in 10 is unluckier)',
